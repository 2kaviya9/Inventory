...
INSTALLED_APPS = INSTALLED_APPS + DJANGO_APPS + LOCAL_APPS
...
DATABASES = {
    'default': {
        ...
        'NAME': 'inventory1',  # Your database name
        'USER': 'inventory_user',  # Your user
        'PASSWORD': 'inventory_password',  # Your password
...
LOGGING = {
    ...
    'loggers': {
        ...
        'my_app': {  # Change 'my_app' to the name of your app
            'handlers': ['debug_file', 'info_file', 'error_file', 'console'],
            'level': 'DEBUG',
            'propagate': False,
        },
